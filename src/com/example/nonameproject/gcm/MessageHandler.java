...
public class MessageHandler extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		/*TODO: SHOW EVENT IN NOTIFICATION
		 * CURRENTLY DUMMY NOTIFICAITON IS BEING SHOWN*/
		...
		//SEND BROADCAST TO THE RECEIVER REGISTER IN 
		//NOTIFICATION ACTIVITY THAT WILL UPDATE THE
		//EVENT LIST THERE AND REMOVE THE NOTIFICAION.
